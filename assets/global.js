...
class VariantSelects extends HTMLElement {
  ...
  filterThumb(){
    if(this.currentVariant.featured_media != null && this.currentVariant.featured_media.alt != null){
      ...
      //var selected_color = this.currentVariant.featured_media.alt;
      //var thumb_selector = '[data-thumb-color="' + selected_color + '"]';
      //$(thumb_selector).show();
      console.log("updated", this.currentVariant.featured_media.alt);
    }
    else{
